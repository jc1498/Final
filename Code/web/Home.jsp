...
<head>
  <title>
    X-Trade - [<%=session.getAttribute("username")%>] Home
  </title>
...
<!-- Trending Products -->
<div class="row">
  <h2 class="w3-wide w3-center" style="font-size:35px; font-family:Times New Roman; margin-top: 10px; font-weight:bold;">Product Categories</h2>
  <div class="column">
    <div class="card">
