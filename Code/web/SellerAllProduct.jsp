...
<head>
	...
	<title> Marketplace - [<%=session.getAttribute("username")%>] Seller's All Product </title>
	<style>
		*{
			margin:0;
			padding: 0;
...
<div>
	<h1 style="text-align:center; padding-bottom: 2%; padding-top:2%; margin-top: 0px; font-size: 60px; font-weight:650; color: #14C9B2; padding-left: 33px;" >Product Sold by Seller</h1>
	<div class="Row">
