...
<head>
	...
	<title> X-Trade - [<%=session.getAttribute("username")%>] Product Table </title>
...
<div style="padding:10px;">
	...
	<div style="color: #007bb6; float:none; padding:10px;">
		<div style="font-size: 3.0em; margin:5px; font-weight:900; text-align:center; padding-bottom:1px;">
			<b>Product Currently Sell by <%=session.getAttribute("username")%></b>
		</div>
...
<div style="margin:0 auto; width:1500px; align-content: center;">
	<p style="font-size:40px; padding-top:20px; border:0px; margin:1% 0% 1% 43%"><b><u>Product Lists</u></b><p>

	<table width="80%" style=" padding:10px; margin-left:8%; ">
	<tr style="font-size:1.4em; background-color:#EEEEEE; text-align:center">
		<td width="3%"><b>Product ID</b> </td>
		<td width="20%"><b>Product Name</b></td>
		<td width="10%"><b>Product Category</b></td>
	...
	<%
		...
		ResultSet res = stml.executeQuery("select * from user.product where user_id = '"+ Uid + "'");
	...
	<tr style=" background-color:#DDDDDD;">
		<td style="padding: 10px; text-align: center;"><%=res.getString("product_id")%></td>
		<td style="padding: 10px;"><%=res.getString("product_name")%></td>
		<td style="padding: 10px 10px 10px 30px; text-align: left;"><%=res.getString("product_category")%></td>
		<td style="padding: 10px; "><%=res.getString("product_description")%></td>
		<td style="padding: 10px 10px 10px 26px; ">
			<a href="Bdetail.jsp?pid=<%=res.getString("product_id")%>">[View]</a>
			<a href="DelProductServlet?pid=<%=res.getString("product_id")%>">[DEL]</a>
		</td>
		<td style="padding: 10px;"><%=res.getString("price")%></td>
	</tr>
	<%
	}
	else {
