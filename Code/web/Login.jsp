...
<h2 style=" font-size: 35px; font-family:Times New Roman; font-weight: bold; padding-left: 10px;">Account Login</h2>
<p style=" font-size: 30px; padding-left: 10px; font-weight: bold; font-family:Times New Roman;"> Welcome To X-Trade</p>

<div class ="Container" style="font-family:Times New Roman; font-size: 20px;">
	<form id="lg" method="post" action="LoginServlet">


		<div class="row">
			<div class="Col-25">
				<label style="font-family:Times New Roman; font-size: 23px;" for="username" style="font-size: 20px;"><b>Username:</b></label>
			</div>

			<div class="Col-75" style="padding-left: 10px;">
				<input  style="font-family:Times New Roman; font-size: 18px;" type="text" placeholder="Enter your username..." id="username" name="username" required/>
			</div>
		</div>

		<div class="row">
			<div class="Col-25">
				<label style="font-family:Times New Roman; font-size: 23px;"for="password" ><b>Password:</b></label>
			</div>

			<div class="Col-75"  style="padding-top: 10px;  width: 240px; padding-left: 10px;">
				<input style="width:266px; height:45px; padding-left: 10px;font-family:Times New Roman; font-size: 18px;" type="password" placeholder="Enter password..." id="password" name="password" required/>
			</div>
		</div>

		<div class="Row" style="padding-left: 10%; margin-bottom: 12%;">
			<div style="margin: 0 auto; padding-left: 35px;" >
				<p>Don't have an Account? <a href="Registration.jsp" style="font-size: 24px;"> Sign Up Now!</a></p>
			</div>
			<input type="submit" value="Submit" onclick="document.getElementById('lg').submit();" style="margin-right: 45%; margin-top: 10px; ">
		</div>
