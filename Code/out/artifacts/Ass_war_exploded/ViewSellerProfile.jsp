...
<head>
    ...
    <title> X-Trade - [<%=session.getAttribute("username")%>] View Seller Profile </title>
...
<%
    ...
    ResultSet Rs = stm.executeQuery("select * from user.users where id = '"+ u_id + "'");
    Rs.next();
        ...
        <tr>
            <td width="50%" style="border:1px solid black;">
                <div style="margin:0 auto; text-align:center; padding:30px;">
                    <div >
                        <img style="width:400px; height: 400px;" src="./SellerImageDisplayServlet?Seller=<%=Rs.getString("id")%>"/> <br/>
                    </div>
                </div>
            ...
            <td width="50%" style="padding-left: 5%; align-content:center;" >
                <table style="padding:15px 10px 20px 10px; font-size: 20px; font-family:Times New Roman;">
                    <tr>
                        <td>Name :</td>
...
<%
    ...
    ResultSet rs = Stm.executeQuery("SELECT Distinct * FROM user.product\n" +
            "where (product_category = 'Clothes & Accessories'or product_category ='Books & Stationery') and user_id = '" + uid + "'\n" +
            "ORDER BY RAND()\n" +
            "LIMIT 1;");
...
<div class="row">
    ...
    <div class="column">
        <div class="card">
            <img src="./ProductDisplayServlet?product_id=<%=rs.getString("product_id")%>"style="width:200px; height:200px; margin-top: 20px;"/>
            <div class="container">
                <h2><%=rs.getString("product_category")%></h2>
                <p class="title" style="height:50px;"><%=rs.getString("product_name")%></p>
    ...
    <div class="column">
        <div class="card">
            <img src="./ProductDisplayServlet?product_id=<%=RES.getString("product_id")%>"style="width:200px; height:200px; margin-top: 20px;"/>
            <div class="container">
                <h2><%=RES.getString("product_category")%></h2>
                <p class="title" style="height:50px;"><%=RES.getString("product_name")%></p>
    ...
    <a href="SellerAllProduct.jsp?uid=<%=RES.getString("user_id")%>">
        <button class="button button4" style="width: 200px; margin-left: 45%; " >View More Product</button>
    </a>
</div>
