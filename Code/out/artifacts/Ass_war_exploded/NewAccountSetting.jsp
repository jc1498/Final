...
<html>
<head>
    <title> X-Trade - [<%=session.getAttribute("username")%>] Account Setting </title>
...
<h2 style=" font-size: 45px; font-weight: bold; font-family:Times New Roman;">Account Setting of <%=session.getAttribute("username")%></h2>
<p style=" font-size: 28px; font-weight: bold; font-family:Times New Roman;">Account Setting / Dashboard</p>
<div class="Container">
    <form id="Up" action="UpdatePersonalInfoServlet" enctype="multipart/form-data" method="post" style=" font-size: 23px; font-family:Times New Roman;">
        ...
        <div class="Row">
            ...
            <div class="Col-75">
                <input style="width:100%; padding:12px;" type="email" id="email" name="email" placeholder="Your Email.." required/>
            </div>
        </div>
        ...
        <div class="Row">
            ...
            <div class="Col-75">
                <input type="text"  name="mobile" id="mobile" placeholder="Enter Your Mobile Number" required/><br>
            </div>
        </div>
        <div class="Row">
            <div class="Col-25">
        ...
        <div class="Row">
            <input type="submit" value="Update" onclick="document.getElementById('Up').submit();">
        </div>
