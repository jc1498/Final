...
<!DOCTYPE html>
<html>
<title>[<%=session.getAttribute("username")%>] Marketplace - Others </title>
<head>
...
<div style= "background-color: #EDEBEB;">
	<h1 style="text-align:center; padding-bottom: 2%; padding-top:2%; margin-top: 0px; font-size: 60px; font-weight:650; color: #A64BC9; padding-left: 33px;" >Others</h1>
	...
	<div class="Row">
		...
		<div class="product">
			<div class="pro-con">
				...
				<h2 style="font-size: 18px; font-weight:bold; color: #A64BC9; text-align: center;"><%=rs.getString("product_name")%></h2>
