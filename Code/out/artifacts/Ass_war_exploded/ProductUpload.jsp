...
<head>
    ...
    <title> X-Trade - [<%=session.getAttribute("username")%>] Upload Product </title>
    <style>
...
<div>
    <h2 style="font-size:37px; font-family:Times New Roman; margin-top: 10px; font-weight:bold;">Upload a Product</h2>
    <p style="font-size:26px; font-family:Times New Roman; ">As a member, you are able to upload your product by filling all sections of this form</p>

    <form id="log" method="post" action="ProductAddServlet" enctype="multipart/form-data">
        <div class="Container" style="font-family:Times New Roman; font-size: 20px;">
            ...
            <div class="Row">
                ...
                <div class="Col-75">
                    <textarea id="product_description" name="product_description" placeholder="Write something about your Product.." style="height:200px"required/></textarea>
                </div>
            </div>
            ...
            <div class="Row">
                ...
                <div class="Col-75">
                    <input type="text" id="price" name="price" placeholder="Product price in RM.."required/>
                </div>
            </div>
            ...
            <div style="padding-bottom: 70px;">
                <input type="submit"  onclick="document.getElementById('log').submit();">
            </div>
    </form>
</div>
