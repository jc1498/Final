...
<html>
<head>
	<title> X-Trade - Registration </title>
	<style>
...
<h2 style=" font-size: 39px; font-weight: bold; font-family:Times New Roman;">Registration Form of X-Trade</h2>
<p style="font-weight: bold; font-size: 26px; font-family:Times New Roman;">
	Sign Up to be a Member of X-Trade
</p>

<div class ="Container" style="margin-left: 3%;">
	<form id="register" method="post" action="RegistrationServlet" enctype="multipart/form-data" style=" font-size: 20px;  font-family:Times New Roman;">
		...
		<div class="Row">
			...
			<div class="Col-75">
				<input type="text" placeholder="Enter your student ID..." id="studentID" name="studentID" required/>
			</div>
		</div>
		...
		<div class="Row">
			...
			<div class="Col-75">
				<input style="width: 100%; height:45px; margin-top: 4px;" type="password" placeholder="  Enter password..." id="password" name="password" required/>
			</div>
		</div>
		...
		<div class="Row">
			...
			<div class="Col-75">
				<select style ="width:10%; height:50px; text-align:center; margin-right:300%; margin-top: 10px; " id="gender" name="gender" required/>
		...
		<div class="Row">
			<input type="submit" value="Submit" onclick="document.getElementById('register').submit();">
		</div>

		<div class="Row">
			<div>
				<p style="padding-left:8%; ">Already have an Account? <a style="font-size: 30px;" href="Login.jsp"><b>Login Here!</b></a></p>
			</div>
		</div>
	</form>
</div>
